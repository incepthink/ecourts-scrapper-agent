// Inline SVG icon set (feather-style stroke icons) used across the app.
// Each takes an optional `size` and spreads the rest onto the <svg>.
...
export const Building = (p) => (
  <Svg {...p}>
    ...
    <path d="M9 9h.01M12 9h.01M15 9h.01M9 13h.01M12 13h.01M15 13h.01M9 17h.01M15 17h.01" />
  </Svg>
);
...
export const Gavel = (p) => (
  <Svg {...p}>
    ...
    <path d="M9.5 6.5l8 8" />
    <path d="M14 4l6 6" />
    <path d="M11.5 1.5l3 3-4 4-3-3 4-4z" />
    <path d="M16 20h6" />
  </Svg>
);
...
// Brand "G" mark for the Google sign-in button (multi-color, fixed viewBox).
export function GoogleMark({ size = 18 }) {
  return (
    <svg className="gmark" width={size} height={size} viewBox="0 0 48 48" aria-hidden="true">
